      ...
      <section className="container mx-auto space-y-4 px-4 py-8">
        <div className="">
          <BreadCrumb>
            ...
            {productParam ? (
              <BreadCrumb.Item to={`/shop?category=${productParam}`}>
        ...
        <div className="borderlg:flex-row flex flex-row gap-4 lg:gap-6">
          ...
          <div className="space-y-8 lg:basis-9/12">
            <div className="lg:gap:6 grid grid-cols-2 gap-4 md:grid-cols-3 md:gap-6 ">
              <ProductList />
            </div>
