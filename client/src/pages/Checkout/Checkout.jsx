        ...
        <div className="flex flex-col lg:flex-row">
          <div className="basis-7/12 px-2 py-4 lg:px-4 lg:py-6 2xl:basis-8/12">
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex flex-row items-center justify-between">
                <h2 className="header-4 | text-sm text-secondary-700">Your shipping information</h2>
              </div>
            ...
            <div className="flex flex-col space-y-6">
              <div className="flex flex-row justify-between">
                <div className="flex flex-row gap-2 md:gap-4">
                  <img className="rounded-lg" src={example} alt="example" width={100} />
              ...
              <div className="flex flex-col gap-4 sm:flex-row-reverse lg:flex-col">
                ...
                <div className="flex-1 text-center">
                  <p className="text-secondary-600">
                    <Link className="text-center text-accent-500 hover:text-accent-700" to="/cart">
                      Back to cart
                    </Link>{' '}
                    or{' '}
                    <Link className="text-center text-accent-500 hover:text-accent-700" to="/">
                      Continue shopping
                    </Link>
                  </p>
                </div>
